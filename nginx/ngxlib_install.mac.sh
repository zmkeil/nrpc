...
sed -i.bak 's/objs\/nginx:	objs/objs\/libngx.a:	objs/g' ./Makefile
sed -i.bak 's/LINK =.*/AR = ar -rcs/g' ./Makefile
sed -i.bak 's/LINK/AR/g' ./Makefile
sed -i.bak 's/-o objs\/nginx/objs\/libngx.a/g' ./Makefile
sed -i.bak 's/	objs\/ngx_modules\.o \\/	objs\/ngx_modules.o/g' ./Makefile
sed -i.bak 's/-lpthread.*//g' ./Makefile
sed -i.bak "s/NULL/NULL,    NULL/g" ./ngx_modules.c
